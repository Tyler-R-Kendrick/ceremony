	...
	return new TransformStream({ async transform(chunk, controller) {
		...
		switch (chunk.type) {
			...
			case "finish": {
				...
				if (enforcedToolChoice != null && ![...toolCallsByToolCallId.values()].some((toolCall) => enforcedToolChoice.type === "required" || toolCall.toolName === enforcedToolChoice.toolName)) {
					controller.enqueue({
						type: "error",
...
//#endregion
export { ToolLoopAgent, generateText, isStepCount, output_exports };
