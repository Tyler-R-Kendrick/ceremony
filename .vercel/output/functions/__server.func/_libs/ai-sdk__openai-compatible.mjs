...
import { InvalidPromptError, InvalidResponseDataError, StreamingToolCallTracker, TooManyEmbeddingValuesForCallError, UnsupportedFunctionalityError, WORKFLOW_DESERIALIZE, WORKFLOW_SERIALIZE, _enum, any, array, boolean, combineHeaders, convertBase64ToUint8Array, convertToBase64, convertToFormData, createEventSourceResponseHandler, createJsonErrorResponseHandler, createJsonResponseHandler, createLanguageModelResponseMetadata, createNullLanguageModelUsage, downloadBlob, generateId, getTopLevelMediaType, isCustomReasoning, literal, looseObject, number, object, parseProviderOptions, postFormDataToApi, postJsonToApi, record, resolveFullMediaType, serializeModelOptions, string, union, withUserAgentSuffix, withoutTrailingSlash } from "./@ai-sdk/gateway+[...].mjs";
...
var OpenAICompatibleChatLanguageModel = function(__wf_cls) {
	...
	})(__wf_cls, "class//@ai-sdk/openai-compatible@3.0.45//OpenAICompatibleChatLanguageModel");
	return __wf_cls;
}(class _OpenAICompatibleChatLanguageModel {
...
var OpenAICompatibleCompletionLanguageModel = function(__wf_cls) {
	(function(__wf_cls, __wf_id) {
		var __wf_sym = Symbol.for("workflow-class-registry");
		(globalThis[__wf_sym] || (globalThis[__wf_sym] = /* @__PURE__ */ new Map())).set(__wf_id, __wf_cls);
		Object.defineProperty(__wf_cls, "classId", {
	...
	})(__wf_cls, "class//@ai-sdk/openai-compatible@3.0.45//OpenAICompatibleCompletionLanguageModel");
	return __wf_cls;
}(class _OpenAICompatibleCompletionLanguageModel {
	constructor(modelId, config) {
		this.specificationVersion = "v4";
		var _a;
		this.modelId = modelId;
...
var OpenAICompatibleEmbeddingModel = function(__wf_cls) {
	(function(__wf_cls, __wf_id) {
		var __wf_sym = Symbol.for("workflow-class-registry");
		(globalThis[__wf_sym] || (globalThis[__wf_sym] = /* @__PURE__ */ new Map())).set(__wf_id, __wf_cls);
		Object.defineProperty(__wf_cls, "classId", {
	...
	})(__wf_cls, "class//@ai-sdk/openai-compatible@3.0.45//OpenAICompatibleEmbeddingModel");
	return __wf_cls;
...
var OpenAICompatibleImageModel = function(__wf_cls) {
	(function(__wf_cls, __wf_id) {
		var __wf_sym = Symbol.for("workflow-class-registry");
		(globalThis[__wf_sym] || (globalThis[__wf_sym] = /* @__PURE__ */ new Map())).set(__wf_id, __wf_cls);
		Object.defineProperty(__wf_cls, "classId", {
	...
	})(__wf_cls, "class//@ai-sdk/openai-compatible@3.0.45//OpenAICompatibleImageModel");
	return __wf_cls;
}(class _OpenAICompatibleImageModel {
	constructor(modelId, config) {
		this.modelId = modelId;
		this.config = config;
		this.specificationVersion = "v4";
...
function createOpenAICompatible(options) {
	...
	const getHeaders = () => withUserAgentSuffix(headers, `ai-sdk/openai-compatible/3.0.45`);
