...
import { require_dist } from "../@ai-sdk/gateway+[...].mjs";
import * as fs from "fs";
import * as net from "net";
import * as path from "path";
//#region node_modules/@vercel/queue/node_modules/mixpart/dist/index.mjs
...
function expand(str, options = {}) {
	if (!str) return [];
	const { max = 1e5, maxLength = 4e6 } = options;
	...
	async fetch(url, init) {
		...
		if (isDebugEnabled()) {
			...
			if (body !== void 0 && body !== null) {
				if (body instanceof ArrayBuffer) logData.bodySize = body.byteLength;
...
//#endregion
export { DuplicateMessageError, QueueClient };
