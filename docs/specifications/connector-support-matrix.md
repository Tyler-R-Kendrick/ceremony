...
| ------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ------------------ | ------------------------------------------------------------------------------------------------------- |
| `a2a`                           | 1.0.0           | `A2A_AGENT_CREDENTIAL` (secret)                                                                                                       | protocol-fixture | AGENT-SURFACES     | `a2a-1.0`, `a2a-0.3`                                                                                    |
...
| `mcp-registry`                  | 1.0.0           | none                                                                                                                                  | protocol-fixture | REGISTRY, SECURITY | `mcp-registry-api-v0.1`, `server-json-2025-12-11`                                                       |
...
| `workos-pipes`                  | 2026.09.18      | `WORKOS_API_KEY` (secret), `WORKOS_CLIENT_ID` (public)                                                                                | protocol-fixture | IDENTITY-BROKERS   | `external-broker`, `workos-pipes-credentials`, `workos-pipes-relay`                                     |
